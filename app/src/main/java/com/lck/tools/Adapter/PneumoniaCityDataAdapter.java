 ...
 * 疫情实时数据适配器(市级)
 */
public class PneumoniaCityDataAdapter extends RecyclerView.Adapter<PneumoniaCityDataAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView textView_provinceName;//市
    ...
    public PneumoniaCityDataAdapter(ArrayList<CityData> dataList) {
        mList = dataList;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pneumoniacitydata,parent,false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        CityData provinceData = mList.get(position);

        holder.textView_provinceName.setText(provinceData.getCityName());
